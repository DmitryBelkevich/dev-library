...
/**
 * checked / catched exceptions (проверенные /проверяемые / обрабатываемые)
 *
 * 1) проверенные (проверяются на этапе компиляциии)
...
/**
 * unchecked / uncatched exceptions (не проверенные / непроверяемые /не обрабатываемые)
 *
 * 1) не проверенные (проверяются на этапе выполнения программы)
 ...
 * RuntimeException - базовый класс для ошибок во время выполнения
 */
