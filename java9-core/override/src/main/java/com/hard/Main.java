...
/**
 * 4) при переопределении методов можно:
 * - изменять порядок выбрасываемых исключений
 * - изменять количество выбрасываемых исключений в меньшую сторону
 * - убрать секцию throws
 * - добавлять новые выбрасываемые исключения, которые наследуются от объявленных выбрасываемых исключений
 * - добавлять новые выбрасываемые исключения, которые наследуются от RuntimeException или Error
 */
